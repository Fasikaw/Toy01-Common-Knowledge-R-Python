...
capitalized.
   ...
   - __Main Elements__
     ...
     ```
 - ### 2. Instances
   - Instances are created from classes that serve as blueprints to determine the attributes and methods of the instances. 
   - It's concrete objects created based on the "blue-print"(class), and each of which is totally independent object. If "class" is an abstract representation of a certain object, while "instance" is a concrete example of a certain object develped from the "class".
   - "class" is like a **catagory**. All objects generated by the same class share the same instance attribute, but the values of the instance attributes for each object are independent! 
     <img src="https://user-images.githubusercontent.com/31917400/77850505-ef479600-71ca-11ea-934b-761b4af6fc3a.png" />
   
   - Let's define the **instance attributes** in the class
