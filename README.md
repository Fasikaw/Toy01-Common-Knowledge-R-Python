...
capitalized.
 ...
 - ### 2. Instances
   - instance = `object` 
   - Instances are created from classes that serve as blueprints to determine the attributes and methods of the instances. They are concrete objects created based on the "blue-print"(class), and each of which is totally independent object. "class" is like a **catagory**. If "class" is an abstract representation of a certain object, while "instance" is a concrete example of a certain object develped from the "class".
